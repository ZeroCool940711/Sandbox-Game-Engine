...
OVERLAY_ARTIFACT = 4
OVERLAY_TREASURE = 5
OVERLAY_ARMOUR_CHEST = 6
OVERLAY_WEAPON_CHEST = 7
OVERLAY_JEWELRY_CHEST = 8
OVERLAY_CURRENCY_CHEST = 9
...
class dungeonGenerator:
	...
	def generateRoads(self, mode = 'r', x = None, y = None):
		"""
		generates a maze of corridors on the growing tree algorithm, 
		where corridors do not overlap with over tiles, are 1 tile away from anything else and there are no diagonals
		Populates self.corridors
	...
	def placeWater(self):
		...
		Returns:
		    none
		"""
		#print [n for n in self.findNeighbours(25,25)]
